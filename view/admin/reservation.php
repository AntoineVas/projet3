  ...
  <body>
    ...
    <div class="reservation">
      <?php
        ...
        $req = $bdd->query('SELECT id, id_client, nom_client, prenom_client, mail_client, films, date from reservation');
        while($donnees = $req->fetch()) {
          echo "ID = ".$donnees['id']." "."ID_client = ".$donnees['id_client']." "."NOM_client = ".$donnees['nom_client']." "."PRENOM_client = ".$donnees['prenom_client']." "."MAIL_client = ".$donnees['mail_client']." "."FILMS = ".$donnees['films']." "."DATE = ".$donnees['date']." "."<br>";
        }
       ?>
    </div>
