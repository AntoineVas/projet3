...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>C1né0-Modification e-mail</title>
  ...
  <body>
    ...
    <div class="text">
      <h1>Changement de votre e-Mail</h1>
    </div>

    <div class="formulaire">
      <form class="" action="../../traitement/modification_mailTr.php" method="post">
        <input type="text" name="nwmail" value="" placeholder="Votre nouvelle adresse e-mail">
